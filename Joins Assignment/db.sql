...
select * from employees where FIRST_NAME='Michael' and LAST_NAME='Rogers';

update employees set JOB_ID='ST_MAN' where FIRST_NAME='Michael' and LAST_NAME='Rogers';

use assignments;
select * from countries;

select concat(lpad(country_name,((80+(length(country_name)))/2) ,''),rpad('', ((80-(length(country_name)))/2),'*')) from countries;
